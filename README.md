...
-- Dragging the window (by titleBar) - suporta touch & mouse (melhor para mobile)
do
...
-- Invisibilidade ao pegar Brainrot (corrigido para não perder a conexão entre toggles)
